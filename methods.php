 ...
 <head>
  ...
  <script type="text/javascript">
	...
	function exec(event, method) {
		...
		// Make sure required fields have values and also auto adjust selection options upon user input
		var allvalid = true;
		$("div."+method+" input.method, div."+method+" select.method").each(function(index) {
	...
	function exectimed(t, event) {
		...
		// Prevent further parsing if field is required and not allowedblank
...
<?php } if (in_array("getaccountaddress", $methods)) { ?>
    <div class="block method getaccountaddress"><h4>getaccountaddress</h4>
     <input class="account method required allowblank" id="getaccountaddress_account" type="text"/>
    </div>
<?php } if (in_array("getaddressesbyaccount", $methods)) { ?>
    <div class="block method getaddressesbyaccount"><h4>getaddressesbyaccount</h4>
     <input class="account method required allowblank" id="getaddressesbyaccount_account" type="text"/>
    </div>
